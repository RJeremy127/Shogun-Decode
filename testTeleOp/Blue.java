...
public class Blue extends LinearOpMode {
    ...
    private void updateTelemetry(LLResult result) {
        ...
        telemetry.addData("=== SERVO SPEED ===", "");
        telemetry.addData("Intake Speed", Sorter.SpindexerDelays.intakeServoSpeed);
        telemetry.addData("Sorting Speed", Sorter.SpindexerDelays.sortingServoSpeed);
        telemetry.addData("Shoot Hi-Vel Speed (>=" + (int) Sorter.SpindexerDelays.shootVelocityThreshold + ")", Sorter.SpindexerDelays.shootHighVelSpeed);
        telemetry.addData("Shoot Lo-Vel Speed (<" + (int) Sorter.SpindexerDelays.shootVelocityThreshold + ")", Sorter.SpindexerDelays.shootLowVelSpeed);
        telemetry.addData("Active", String.format("%.2f (%s)",
        ...
        telemetry.addData("Pattern", String.join(" > ", Sorter.getCurrentPattern()));
        telemetry.addData("Pattern Match", Sorter.ShootingPattern.enablePatternMatching ? "ON" : "OFF");
        telemetry.addData("", "");

        telemetry.addData("=== SPINDEXER ===", "");
        telemetry.addData("Trigger Spindexer", triggerSpindexerEnabled ? "ON (G2 triggers = spin)" : "OFF (G2 circle to enable)");
        telemetry.addData("Slot", Sorter.getStep() == -1 ? "INIT" : "Slot " + (Sorter.getStep() + 1));
        telemetry.addData("Servo1 pos", String.format("%.4f", Sorter.getCurrentPos()));
        telemetry.addData("Servo2 pos", String.format("%.4f", 1.0 - Sorter.getCurrentPos()));
        telemetry.addData("Settle", Sorter.isSettled() ? "SETTLED" : "MOVING");
        telemetry.addData("Transfer", Sorter.isTransferActive()
                ? "ACTIVE " + (int) Sorter.getTransferTimeLeft() + "ms left"
                : Sorter.isTransferPending() ? "RESETTING TO SLOT1" : "IDLE");
        telemetry.addData("", "");

        telemetry.addData("=== DISTANCE SENSORS ===", "");
        telemetry.addData("Sensor Gate", sensorsEnabled ? "ON" : "WAITING (settling)");
        telemetry.addData("Analog Ranger", BallDetector.BallDetection.useAnalogRanger ? "ENABLED" : "DISABLED");
        telemetry.addData("Ranger Distance (in)", String.format("%.3f  thresh=%.2f  %s",
        ...
        telemetry.addData("Ranger Voltage", String.format("%.4fV", BallDetector.getRangerVoltage()));
        telemetry.addData("Color Sensor 1 Distance", BallDetector.BallDetection.useCS1Distance ? "ENABLED" : "DISABLED");
        if (BallDetector.hasCS1Distance()) {
            telemetry.addData("Color Sensor 1 Distance (mm)", String.format("%.1f  thresh=%.1f  %s",
        ...
        telemetry.addData("Color Sensor 2 Distance", BallDetector.BallDetection.useCS2Distance ? "ENABLED" : "DISABLED");
        if (BallDetector.hasCS2Distance()) {
            telemetry.addData("Color Sensor 2 Distance (mm)", String.format("%.1f  thresh=%.1f  %s",
        ...
        telemetry.addData("Ball Detected", (sensorsEnabled && BallDetector.detectBall()) ? "YES" : "NO");
        telemetry.addData("Analog Settle Delay", BallDetector.BallDetection.analogSettleDelayMs + "ms  (color dist sensor = 0ms)");
        telemetry.addData("Startup Delay", BallDetector.BallDetection.startupDelayMs + "ms");
        telemetry.addData("", "");

        telemetry.addData("=== COLOR SENSOR ONE ===", Color.ColorConfig.enableSensor1 ? "ENABLED" : "DISABLED");
        telemetry.addData("Color Sensor 1 Gain", Color.ColorSensor1.gain);
        telemetry.addData("Color Sensor 1 Alpha", String.format("%.4f", cs1[3]));
        telemetry.addData("Color Sensor 1 Red", String.format("%.4f", cs1[0]));
        telemetry.addData("Color Sensor 1 Green", String.format("%.4f", cs1[1]));
        telemetry.addData("Color Sensor 1 Blue", String.format("%.4f", cs1[2]));
        telemetry.addData("Color Sensor 1 Green Thresh", String.format("R[%.2f-%.2f] G[%.2f-%.2f] B[%.2f-%.2f]",
        ...
        telemetry.addData("Color Sensor 1 Purple Thresh", String.format("R[%.2f-%.2f] G[%.2f-%.2f] B[%.2f-%.2f]",
        ...
        telemetry.addData("Color Sensor 1 Result", Color.isCS1Green() ? "GREEN" : Color.isCS1Purple() ? "PURPLE" : "none");
        telemetry.addData("", "");

        telemetry.addData("=== COLOR SENSOR TWO ===", Color.ColorConfig.enableSensor2 ? "ENABLED" : "DISABLED");
        telemetry.addData("Color Sensor 2 Gain", Color.ColorSensor2.gain);
        telemetry.addData("Color Sensor 2 Alpha", String.format("%.4f", cs2[3]));
        telemetry.addData("Color Sensor 2 Red", String.format("%.4f", cs2[0]));
        telemetry.addData("Color Sensor 2 Green", String.format("%.4f", cs2[1]));
        telemetry.addData("Color Sensor 2 Blue", String.format("%.4f", cs2[2]));
        telemetry.addData("Color Sensor 2 Green Thresh", String.format("R[%.2f-%.2f] G[%.2f-%.2f] B[%.2f-%.2f]",
        ...
        telemetry.addData("Color Sensor 2 Purple Thresh", String.format("R[%.2f-%.2f] G[%.2f-%.2f] B[%.2f-%.2f]",
        ...
        telemetry.addData("Color Sensor 2 Result", Color.isCS2Green() ? "GREEN" : Color.isCS2Purple() ? "PURPLE" : "none");
        telemetry.addData("Last Color Detected", Color.getLastDetected() != null ? Color.getLastDetected().toUpperCase() : "NONE");
        telemetry.addData("Color Timeout", Color.ColorConfig.colorTimeoutMs + "ms");
        telemetry.addData("", "");

        telemetry.addData("=== FLYWHEEL ===", "");
        telemetry.addData("Equation", Flywheel.FlywheelEquation.enableEquation ? "ON (G2 dpad_right to off)" : "OFF (G2 dpad_right to on)");
        telemetry.addData("Eq tyA", Flywheel.FlywheelEquation.tyA);
        telemetry.addData("Eq tyB", Flywheel.FlywheelEquation.tyB);
        telemetry.addData("Target", String.format("%.1f tks/s", Flywheel.FlywheelPID.targetVelocity));
        telemetry.addData("Actual", String.format("%.1f tks/s", Flywheel.getVelocity()));
        telemetry.addData("Error", String.format("%.1f", Flywheel.getError()));
        telemetry.addData("Power", String.format("%.3f", Flywheel.getPower()));
        telemetry.addData("Close Preset", Flywheel.FlywheelPID.closeRangeVelocity);
        telemetry.addData("Long Preset", Flywheel.FlywheelPID.longRangeVelocity);
        telemetry.addData("Transfer Motor", String.format("%.3f", Sorter.getTransferMotorPower()));
        telemetry.addData("", "");

        telemetry.addData("=== TURRET ===", "");
        if (Turret.isWraparoundActive()) {
            telemetry.addData("Turret", "WRAPPING -> " + Turret.getWraparoundTarget());
        } else {
            telemetry.addData("Turret Ticks", Turret.getPosition());
            telemetry.addData("Turret Power", String.format("%.3f", Turret.getPower()));
        }
        telemetry.addData("Tracking", Turret.isTrackingEnabled() ? "ON" : "OFF");
        telemetry.addData("Deadzone", String.format("+/- %.2f", Turret.TurretTracking.txDeadzone));
        if (valid) {
            double txVal = result.getTx();
            telemetry.addData("tx", String.format("%.3f  %s", txVal,
