...
public class Tickle {
    ...
    // Servo positions
    private static final double minPosition = 0.03;
    private static final double maxPosition = 0.36;
    private static final double transferPosition = 0.03;
    private static final double blockBallPosition = 0.08;
